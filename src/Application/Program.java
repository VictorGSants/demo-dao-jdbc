...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("Insira o id do funcionario que voce deseja mudar nome ");
        int idFuncionario = sc.nextInt();
        System.out.println("Insira o novo nome desse funcionario: ");
        ...
        System.out.println("Insira o id do funcionario que voce deseja deletar ");
        idFuncionario = sc.nextInt();
        sellerDao.deleteById(idFuncionario);
